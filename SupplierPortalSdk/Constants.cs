...
namespace eFlow.SupplierPortalCore
{
    ...
    public class Constants
    {
        ...
        //public const string cStrChilkatFtpLic = "FTP!TEAMCRD!_rAy8OuCQ9R4o"; // Not valid for .NET 4.0 64 Bits
        public const string cStrChilkatFtpLic = "any string";
        ...
        // urls
        public static string cStrDomain = "documentportal.aws.af.cm";
        ...
        // eFlow Dynamic
        public const string cStrDynamicReg = @"Software\Wow6432Node\TopImageSystems\eFLOW 5";
